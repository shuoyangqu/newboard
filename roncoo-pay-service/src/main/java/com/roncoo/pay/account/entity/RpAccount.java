 ...
 * @Author: qsy
 * @Description: 账户信息
 * @Date: Created in 下午 1:54 2018/10/13/013
 */
public class RpAccount extends BaseEntity implements Serializable {

    private static final long serialVersionUID = -4103013307359313051L;
    /** 账户编号 **/
    ...
    public BigDecimal getAvailableSettAmount(){
        BigDecimal subSettAmout=this.settAmount.subtract(unbalance);
        if (getAvailableBalance().compareTo(subSettAmout)==-1) {
