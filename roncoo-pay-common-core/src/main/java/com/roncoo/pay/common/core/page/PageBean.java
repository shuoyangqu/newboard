 ...
 * @Author: qsy
 * @Description: 分页组件
 * @Date: Created in 下午 3:12 2018/10/11/011
 */
public class PageBean<T> implements Serializable {

    private static final long serialVersionUID = 7562635302806802107L;
     ...
     * 本页的数据列表
     */
    private List<T> recordList = new ArrayList<>(0);
