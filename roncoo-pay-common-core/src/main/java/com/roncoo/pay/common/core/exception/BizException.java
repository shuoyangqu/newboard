 ...
 * @Date: Created in 下午 2:54 2018/10/11/011
 */
public class BizException extends RuntimeException {

    private static final long serialVersionUID = 2609571987291098819L;
    ...
    public BizException(int code, String msgFormat,Object... args) {
        ...
        this.code=code;
        this.msgFormat=String.format(msgFormat,args);
    }
    ...
    /**
     * 会话超时，获取session时，如果是空，throws下面这个异常 ，拦截器会拦截报会话超时页面
     */
